...
import ModalDropdownState from './ModalDropdownState';
const data = [
...
const StateInNigeriaScreen = ({visible, setVisible, visible2, setVisible2}) => {
...
export default StateInNigeriaScreen;
